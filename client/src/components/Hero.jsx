...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-6 sm:gap-8 md:gap-10 py-4 sm:py-10 md:py-12 lg:py-16 max-w-6xl w-full">
        {/* Logo with animation */}
        <motion.div 
        ...
        >
          <div className="relative">
            <Logo />
            <div className="absolute -inset-4 bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-2xl blur-xl opacity-30 -z-10"></div>
          </div>
        </motion.div>
          ...
          <div className="flex flex-col items-center ">
            ...
            <div className="w-5 h-8 border-2 border-gray-300 dark:border-gray-600 rounded-full flex justify-center">
              <motion.div
                ...
                className="w-1 h-1 bg-gradient-to-b from-emerald-500 to-cyan-500 rounded-full mt-2"
              ></motion.div>
            </div>
          </div>
        </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white dark:from-gray-900 to-transparent z-0"></div>
    </section>
  );
};
